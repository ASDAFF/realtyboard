...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sublocality.big_sublocality'
        db.alter_column(u'board_sublocality', 'big_sublocality_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.BigSublocality'], null=True))

    def backwards(self, orm):

        # Changing field 'Sublocality.big_sublocality'
        db.alter_column(u'board_sublocality', 'big_sublocality_id', self.gf('django.db.models.fields.related.ForeignKey')(default=111111, to=orm['board.BigSublocality']))
