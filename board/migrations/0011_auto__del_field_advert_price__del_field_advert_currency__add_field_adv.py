...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Advert.price'
        db.delete_column(u'board_advert', 'price')

        # Deleting field 'Advert.currency'
        db.delete_column(u'board_advert', 'currency')

        # Adding field 'Advert.price_uah'
        db.add_column(u'board_advert', 'price_uah',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Advert.price_usd'
        db.add_column(u'board_advert', 'price_usd',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Advert.price'
        db.add_column(u'board_advert', 'price',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Advert.currency'
        db.add_column(u'board_advert', 'currency',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1, max_length=5, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Advert.price_uah'
        db.delete_column(u'board_advert', 'price_uah')

        # Deleting field 'Advert.price_usd'
        db.delete_column(u'board_advert', 'price_usd')
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 26, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'board.extrarent': {
            ...
            'advert': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['board.Advert']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'term': ('django.db.models.fields.SmallIntegerField', [], {'blank': 'True'})
        },
        u'board.extrasale': {
