...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Category.list_region'
        db.alter_column(u'board_category', 'list_region', self.gf('django.db.models.fields.TextField')(max_length=4000, null=True))

    def backwards(self, orm):

        # Changing field 'Category.list_region'
        db.alter_column(u'board_category', 'list_region', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True))
