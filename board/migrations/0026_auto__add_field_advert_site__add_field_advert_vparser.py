...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advert.site'
        # db.add_column(u'board_advert', 'site',
        #               self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
        #               keep_default=False)

        # Adding field 'Advert.vparser'
        db.add_column(u'board_advert', 'vparser',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Advert.site'
        # db.delete_column(u'board_advert', 'site')

        # Deleting field 'Advert.vparser'
        db.delete_column(u'board_advert', 'vparser')
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 8, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 8, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
