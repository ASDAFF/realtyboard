...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExtraFlat.condition'
        db.alter_column(u'board_extraflat', 'condition', self.gf('django.db.models.fields.IntegerField')(max_length=70))

        # Changing field 'ExtraHouse.condition'
        db.alter_column(u'board_extrahouse', 'condition', self.gf('django.db.models.fields.IntegerField')(max_length=70))

    def backwards(self, orm):

        # Changing field 'ExtraFlat.condition'
        db.alter_column(u'board_extraflat', 'condition', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'ExtraHouse.condition'
        db.alter_column(u'board_extrahouse', 'condition', self.gf('django.db.models.fields.CharField')(max_length=70))
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'price_unit': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True'}),
        ...
        u'board.extraflat': {
            ...
            'advert': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['board.Advert']", 'unique': 'True'}),
            'condition': ('django.db.models.fields.IntegerField', [], {'max_length': '70', 'blank': 'True'}),
