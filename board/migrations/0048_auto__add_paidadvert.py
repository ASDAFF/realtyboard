...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PaidAdvert'
        db.create_table(u'board_paidadvert', (
            ...
            ('service', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'board', ['PaidAdvert'])


    def backwards(self, orm):
        # Deleting model 'PaidAdvert'
        db.delete_table(u'board_paidadvert')
    ...
    models = {
        ...
        u'board.paidadvert': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.NullBooleanField', [], {'default': 'True', 'null': 'True', 'blank': 'True'}),
            'service': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'board.phone': {
