...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StatAdvert'
        db.create_table(u'board_statadvert', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.City'])),
            ('creation_date', self.gf('django.db.models.fields.DateField')(default='20.6.2016')),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('prodam_kvartiru', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('prodam_komnatu', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('prodam_dom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('prodam_uchastok', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('prodam_nedvizhimost', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('sdam_kvartiru', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('sdam_komnatu', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('sdam_dom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('sdam_uchastok', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('sdam_nedvizhimost', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'board', ['StatAdvert'])


    def backwards(self, orm):
        # Deleting model 'StatAdvert'
        db.delete_table(u'board_statadvert')
    ...
    models = {
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 6, 21, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'board.messageforusers': {
            'Meta': {'object_name': 'MessageForUsers'},
            'location': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
        ...
        u'board.metrodetect': {
            'Meta': {'object_name': 'MetroDetect'},
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['board.City']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'metro': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['board.Metro']"}),
        ...
        u'board.statadvert': {
            'Meta': {'object_name': 'StatAdvert'},
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['board.City']"}),
            'creation_date': ('django.db.models.fields.DateField', [], {'default': "'20.6.2016'"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'prodam_dom': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'prodam_komnatu': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'prodam_kvartiru': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'prodam_nedvizhimost': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'prodam_uchastok': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'sdam_dom': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'sdam_komnatu': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'sdam_kvartiru': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'sdam_nedvizhimost': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'sdam_uchastok': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
