...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Seo.city'
        db.add_column(u'board_seo', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=20, to=orm['board.City']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Seo.city'
        db.delete_column(u'board_seo', 'city_id')
