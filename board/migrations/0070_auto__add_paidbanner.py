...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PaidBanner'
        db.create_table(u'board_paidbanner', (
            ...
            ('expiration_date', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
        ...
        db.send_create_signal(u'board', ['PaidBanner'])


    def backwards(self, orm):
        # Deleting model 'PaidBanner'
        db.delete_table(u'board_paidbanner')
