...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Advert.price_unit'
        db.add_column(u'board_advert', 'price_unit',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=None, blank=True),
                      keep_default=False)


        # Changing field 'Advert.city'
        db.alter_column(u'board_advert', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['board.City']))

        # Changing field 'Advert.sublocality'
        db.alter_column(u'board_advert', 'sublocality_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['board.Sublocality']))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'board_extrasale', (
            ...
            ('price_unit', self.gf('django.db.models.fields.SmallIntegerField')(blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'board', ['ExtraSale'])

        # Deleting field 'Advert.price_unit'
        db.delete_column(u'board_advert', 'price_unit')


        # Changing field 'Advert.city'
        db.alter_column(u'board_advert', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.City'], null=True))

        # Changing field 'Advert.sublocality'
        db.alter_column(u'board_advert', 'sublocality_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.Sublocality'], null=True))
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 11, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 11, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
