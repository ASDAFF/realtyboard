...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExtraCommercial'
        db.create_table(u'board_extracommercial', (
        ...
        db.send_create_signal(u'board', ['ExtraCommercial'])

        # Deleting field 'Advert.object_type'
        db.delete_column(u'board_advert', 'object_type_id')


        # Changing field 'Advert.category'
        db.alter_column(u'board_advert', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=123, to=orm['board.Category']))

    def backwards(self, orm):
        # Deleting model 'ExtraCommercial'
        db.delete_table(u'board_extracommercial')

        # Adding field 'Advert.object_type'
        db.add_column(u'board_advert', 'object_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.ObjectType'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Advert.category'
        db.alter_column(u'board_advert', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.Category'], null=True))
