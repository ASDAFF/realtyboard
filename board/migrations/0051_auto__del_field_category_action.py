...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Category.action'
        db.delete_column(u'board_category', 'action')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Category.action'
        raise RuntimeError("Cannot reverse this migration. 'Category.action' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Category.action'
        db.add_column(u'board_category', 'action',
