...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Advert.slug'
        db.alter_column(u'board_advert', 'slug', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Advert.raw_phones'
        db.alter_column(u'board_advert', 'raw_phones', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Advert.title'
        db.alter_column(u'board_advert', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Advert.street'
        db.alter_column(u'board_advert', 'street', self.gf('django.db.models.fields.CharField')(default='', max_length=120))

        # Changing field 'Advert.contact_name'
        db.alter_column(u'board_advert', 'contact_name', self.gf('django.db.models.fields.CharField')(default='', max_length=60))

    def backwards(self, orm):

        # Changing field 'Advert.slug'
        db.alter_column(u'board_advert', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Advert.raw_phones'
        db.alter_column(u'board_advert', 'raw_phones', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Advert.title'
        db.alter_column(u'board_advert', 'title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Advert.street'
        db.alter_column(u'board_advert', 'street', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))

        # Changing field 'Advert.contact_name'
        db.alter_column(u'board_advert', 'contact_name', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
