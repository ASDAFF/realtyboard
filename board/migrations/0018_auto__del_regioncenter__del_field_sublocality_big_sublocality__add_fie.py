...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sublocality.in_city'
        db.add_column(u'board_sublocality', 'in_city',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Sublocality.in_city'
        db.delete_column(u'board_sublocality', 'in_city')
