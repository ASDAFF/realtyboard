...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MessageForUsers'
        db.create_table(u'board_messageforusers', (
            ('text', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('location', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
        ))
        db.send_create_signal(u'board', ['MessageForUsers'])


    def backwards(self, orm):
        # Deleting model 'MessageForUsers'
        db.delete_table(u'board_messageforusers')
    ...
    models = {
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 11, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
