...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SeoGenerator'
        db.create_table(u'board_seogenerator', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.City'], null=True, blank=True)),
            ('first', self.gf('django.db.models.fields.TextField')(max_length=4000)),
            ('second', self.gf('django.db.models.fields.TextField')(max_length=4000)),
            ('third', self.gf('django.db.models.fields.TextField')(max_length=4000)),
        ))
        db.send_create_signal(u'board', ['SeoGenerator'])


    def backwards(self, orm):
        # Deleting model 'SeoGenerator'
        db.delete_table(u'board_seogenerator')
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 21, 0, 0)'}),
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 21, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 21, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'board.choice': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 21, 0, 0)'}),
