...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExtraRent.term'
        db.alter_column(u'board_extrarent', 'term', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ExtraRent.term'
        db.alter_column(u'board_extrarent', 'term', self.gf('django.db.models.fields.SmallIntegerField')(default=datetime.datetime(2013, 12, 27, 0, 0)))
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 27, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
