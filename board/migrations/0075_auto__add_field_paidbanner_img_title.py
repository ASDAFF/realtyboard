...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaidBanner.img_title'
        db.add_column(u'board_paidbanner', 'img_title',
                      self.gf('django.db.models.fields.CharField')(default='title', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaidBanner.img_title'
        db.delete_column(u'board_paidbanner', 'img_title')
