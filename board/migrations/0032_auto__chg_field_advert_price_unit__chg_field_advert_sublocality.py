...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Advert.price_unit'
        db.alter_column(u'board_advert', 'price_unit', self.gf('django.db.models.fields.SmallIntegerField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Advert.price_unit'
        db.alter_column(u'board_advert', 'price_unit', self.gf('django.db.models.fields.SmallIntegerField')(default=4566))

        # Changing field 'Advert.sublocality'
        db.alter_column(u'board_advert', 'sublocality_id', self.gf('django.db.models.fields.related.ForeignKey')(default=7894, to=orm['board.Sublocality']))
