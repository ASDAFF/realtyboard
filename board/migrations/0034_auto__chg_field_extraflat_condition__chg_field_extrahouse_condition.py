...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'board_extraflat', 'condition', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ExtraHouse.condition'
        db.alter_column(u'board_extrahouse', 'condition', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ExtraFlat.condition'
        db.alter_column(u'board_extraflat', 'condition', self.gf('django.db.models.fields.IntegerField')(default=None, max_length=70))

        # Changing field 'ExtraHouse.condition'
        db.alter_column(u'board_extrahouse', 'condition', self.gf('django.db.models.fields.IntegerField')(default=None, max_length=70))
