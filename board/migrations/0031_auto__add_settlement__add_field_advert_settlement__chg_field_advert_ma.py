...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'board_settlement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('sublocality', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.Sublocality'])),
        ))
        db.send_create_signal(u'board', ['Settlement'])

        # Adding field 'Advert.settlement'
        db.add_column(u'board_advert', 'settlement',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.Settlement'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Advert.main_text'
        db.alter_column(u'board_advert', 'main_text', self.gf('django.db.models.fields.TextField')(default=None, max_length=1000))

    def backwards(self, orm):
        # Deleting model 'Settlement'
        db.delete_table(u'board_settlement')

        # Deleting field 'Advert.settlement'
        db.delete_column(u'board_advert', 'settlement_id')


        # Changing field 'Advert.main_text'
        db.alter_column(u'board_advert', 'main_text', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True))
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 14, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 14, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
