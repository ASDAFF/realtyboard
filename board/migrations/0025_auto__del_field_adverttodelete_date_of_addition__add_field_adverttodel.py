...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'AdvertToDelete', fields ['advert']
        db.delete_unique(u'board_adverttodelete', ['advert_id'])

        # Adding field 'AdvertToDelete.date_of_addition'
        db.add_column(u'board_adverttodelete', 'date_of_addition',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 4, 4, 0, 0)),
                      keep_default=False)

        # Deleting field 'AdvertToDelete.date_of_del'
        db.delete_column(u'board_adverttodelete', 'date_of_del')


        # Changing field 'AdvertToDelete.advert'
        db.alter_column(u'board_adverttodelete', 'advert_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.Advert']))
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 4, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 4, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
