...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'City.name_pr'
        db.add_column(u'board_city', 'name_pr',
                      self.gf('django.db.models.fields.TextField')(default='d', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'City.name_pr'
        db.delete_column(u'board_city', 'name_pr')
    ...
    models = {
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 1, 22, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'board.city': {
            ...
            'name_pr': ('django.db.models.fields.TextField', [], {'max_length': '30'}),
            'seo_text': ('django.db.models.fields.TextField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
