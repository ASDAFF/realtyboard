...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Big_sublocality'
        db.delete_table(u'board_big_sublocality')

        # Adding model 'BigSublocality'
        db.create_table(u'board_bigsublocality', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.City'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'board', ['BigSublocality'])
        ...
        # Deleting field 'Sublocality.subloc_province'
        db.delete_column(u'board_sublocality', 'subloc_province_id')

        # Adding field 'Sublocality.big_sublocality'
        db.add_column(u'board_sublocality', 'big_sublocality',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=22222, to=orm['board.BigSublocality']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'Big_sublocality'
        db.create_table(u'board_big_sublocality', (
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.City'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'board', ['Big_sublocality'])

        # Deleting model 'BigSublocality'
        db.delete_table(u'board_bigsublocality')

        # Deleting model 'RegionCenter'
        db.delete_table(u'board_regioncenter')

        # Adding field 'Sublocality.subloc_province'
        db.add_column(u'board_sublocality', 'subloc_province',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=22222, to=orm['board.Big_sublocality']),
                      keep_default=False)
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 3, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'board.sublocality': {
            ...
            'big_sublocality': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['board.BigSublocality']"}),
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['board.City']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '25'})
        },
