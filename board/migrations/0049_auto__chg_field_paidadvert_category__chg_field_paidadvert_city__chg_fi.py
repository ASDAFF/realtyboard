...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PaidAdvert.category'
        db.alter_column(u'board_paidadvert', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.Category'], null=True))

        # Changing field 'PaidAdvert.city'
        db.alter_column(u'board_paidadvert', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.City'], null=True))

        # Changing field 'PaidAdvert.service'
        db.alter_column(u'board_paidadvert', 'service', self.gf('django.db.models.fields.SmallIntegerField')(default=2))

    def backwards(self, orm):

        # Changing field 'PaidAdvert.category'
        db.alter_column(u'board_paidadvert', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['board.Category']))

        # Changing field 'PaidAdvert.city'
        db.alter_column(u'board_paidadvert', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['board.City']))

        # Changing field 'PaidAdvert.service'
        db.alter_column(u'board_paidadvert', 'service', self.gf('django.db.models.fields.SmallIntegerField')(null=True))
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 28, 0, 0)'}),
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'board.choice': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 28, 0, 0)'}),
