...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advert.big_sublocality'
        db.add_column(u'board_advert', 'big_sublocality',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.BigSublocality'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Advert.big_sublocality'
        db.delete_column(u'board_advert', 'big_sublocality_id')
    ...
    models = {
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 22, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
