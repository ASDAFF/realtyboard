...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Choice.phone'
        db.add_column(u'board_choice', 'phone',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['board.Phone']),
                      keep_default=False)


        # Changing field 'Choice.choice_text'
        db.alter_column(u'board_choice', 'choice_text', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Choice.votes'
        db.alter_column(u'board_choice', 'votes', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):
        # Deleting field 'Choice.phone'
        db.delete_column(u'board_choice', 'phone_id')


        # Changing field 'Choice.choice_text'
        db.alter_column(u'board_choice', 'choice_text', self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 4, 24, 0, 0), max_length=200))

        # Changing field 'Choice.votes'
        db.alter_column(u'board_choice', 'votes', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 24, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'price_usd': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 24, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'board.choice': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 24, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['personal.UserData']", 'null': 'True', 'blank': 'True'}),
            'votes': ('django.db.models.fields.BooleanField', [], {})
        },
        u'board.city': {
