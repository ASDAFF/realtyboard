...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SublocalityDetect'
        db.create_table(u'board_sublocalitydetect', (
        ...
        db.send_create_signal(u'board', ['SublocalityDetect'])


    def backwards(self, orm):
        # Deleting model 'SublocalityDetect'
        db.delete_table(u'board_sublocalitydetect')
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 2, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
