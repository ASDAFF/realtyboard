...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PaidBanner.expiration_date'
        db.alter_column(u'board_paidbanner', 'expiration_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'PaidBanner.expiration_date'
        db.alter_column(u'board_paidbanner', 'expiration_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 9, 16, 0, 0)))
    ...
    models = {
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 16, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
