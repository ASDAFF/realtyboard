...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'board_advert', 'title', self.gf('django.db.models.fields.CharField')(max_length=90))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Advert.title'
        db.alter_column(u'board_advert', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))
