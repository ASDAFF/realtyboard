...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Advert.link'
        db.alter_column(u'board_advert', 'link', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))

    def backwards(self, orm):

        # Changing field 'Advert.link'
        db.alter_column(u'board_advert', 'link', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True))
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 7, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
