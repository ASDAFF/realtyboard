...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.city'
        db.add_column(u'board_category', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=12, to=orm['board.City']),
                      keep_default=False)

        # Adding field 'Category.list_region'
        db.add_column(u'board_category', 'list_region',
                      self.gf('django.db.models.fields.TextField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.city'
        db.delete_column(u'board_category', 'city_id')

        # Deleting field 'Category.list_region'
        db.delete_column(u'board_category', 'list_region')
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 8, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 8, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'board.category': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'list_region': ('django.db.models.fields.TextField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        u'board.choice': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 8, 0, 0)'}),
