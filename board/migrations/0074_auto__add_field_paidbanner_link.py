...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaidBanner.link'
        db.add_column(u'board_paidbanner', 'link',
                      self.gf('django.db.models.fields.CharField')(default='link', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaidBanner.link'
        db.delete_column(u'board_paidbanner', 'link')
    ...
    models = {
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 17, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
