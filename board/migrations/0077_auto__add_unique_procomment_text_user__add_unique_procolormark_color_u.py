...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ProComment', fields ['text', 'user']
        db.create_unique(u'board_procomment', ['text', 'user_id'])

        # Adding unique constraint on 'ProColorMark', fields ['color', 'user']
        db.create_unique(u'board_procolormark', ['color', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProColorMark', fields ['color', 'user']
        db.delete_unique(u'board_procolormark', ['color', 'user_id'])

        # Removing unique constraint on 'ProComment', fields ['text', 'user']
        db.delete_unique(u'board_procomment', ['text', 'user_id'])
    ...
    models = {
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 29, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
