...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'board_sublocality', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.City'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=25)),
        ))
        db.send_create_signal(u'board', ['Sublocality'])

        # Deleting field 'Advert.non_admin_sublocality'
        db.delete_column(u'board_advert', 'non_admin_sublocality_id')

        # Deleting field 'Advert.admin_sublocality'
        db.delete_column(u'board_advert', 'admin_sublocality_id')

        # Adding field 'Advert.sublocality'
        db.add_column(u'board_advert', 'sublocality',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.Sublocality'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'board_sublocality')

        # Adding field 'Advert.non_admin_sublocality'
        db.add_column(u'board_advert', 'non_admin_sublocality',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.NonAdminSublocality'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Advert.admin_sublocality'
        db.add_column(u'board_advert', 'admin_sublocality',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.AdminSublocality'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Advert.sublocality'
        db.delete_column(u'board_advert', 'sublocality_id')
