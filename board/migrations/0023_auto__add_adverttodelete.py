...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdvertToDelete'
        db.create_table(u'board_adverttodelete', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('advert', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.Advert'])),
            ('date_of_addition', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'board', ['AdvertToDelete'])


    def backwards(self, orm):
        # Deleting model 'AdvertToDelete'
        db.delete_table(u'board_adverttodelete')
    ...
    models = {
        ...
        u'board.adverttodelete': {
            ...
            'date_of_addition': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
