...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'board_paidbanner', 'expiration_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 9, 16, 0, 0)))

    def backwards(self, orm):

        # Changing field 'PaidBanner.expiration_date'
        db.alter_column(u'board_paidbanner', 'expiration_date', self.gf('django.db.models.fields.DateField')(null=True))
