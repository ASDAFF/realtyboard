...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MetroDetect'
        db.create_table(u'board_metrodetect', (
            ...
            ('metro', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.Metro'])),
        ))
        db.send_create_signal(u'board', ['MetroDetect'])


    def backwards(self, orm):
        # Deleting model 'MetroDetect'
        db.delete_table(u'board_metrodetect')
    ...
    models = {
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 11, 12, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
