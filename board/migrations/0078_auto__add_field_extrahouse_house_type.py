...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExtraHouse.house_type'
        db.add_column(u'board_extrahouse', 'house_type',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExtraHouse.house_type'
        db.delete_column(u'board_extrahouse', 'house_type')
    ...
    models = {
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 20, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
