...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Poll'
        db.create_table(u'board_poll', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'board', ['Poll'])

        # Adding model 'Choice'
        db.create_table(u'board_choice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('poll', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.Poll'])),
            ('choice_text', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('votes', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.UserData'], null=True, blank=True)),
        ))
        db.send_create_signal(u'board', ['Choice'])


    def backwards(self, orm):
        # Deleting model 'Poll'
        db.delete_table(u'board_poll')

        # Deleting model 'Choice'
        db.delete_table(u'board_choice')
