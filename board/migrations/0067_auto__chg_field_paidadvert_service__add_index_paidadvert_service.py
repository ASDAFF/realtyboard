...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'PaidAdvert.service' to match new field type.
        db.rename_column(u'board_paidadvert', 'service', 'service_id')
        # Changing field 'PaidAdvert.service'
        db.alter_column(u'board_paidadvert', 'service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.PayedService']))
        # Adding index on 'PaidAdvert', fields ['service']
        db.create_index(u'board_paidadvert', ['service_id'])


    def backwards(self, orm):
        # Removing index on 'PaidAdvert', fields ['service']
        db.delete_index(u'board_paidadvert', ['service_id'])


        # Renaming column for 'PaidAdvert.service' to match new field type.
        db.rename_column(u'board_paidadvert', 'service_id', 'service')
        # Changing field 'PaidAdvert.service'
        db.alter_column(u'board_paidadvert', 'service', self.gf('django.db.models.fields.SmallIntegerField')())
    ...
    models = {
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 4, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
