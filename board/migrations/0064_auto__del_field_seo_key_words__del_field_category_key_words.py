...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Seo.key_words'
        db.delete_column(u'board_seo', 'key_words')

        # Deleting field 'Category.key_words'
        db.delete_column(u'board_category', 'key_words')


    def backwards(self, orm):
        # Adding field 'Seo.key_words'
        db.add_column(u'board_seo', 'key_words',
                      self.gf('django.db.models.fields.TextField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.key_words'
        db.add_column(u'board_category', 'key_words',
                      self.gf('django.db.models.fields.TextField')(max_length=1000, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 5, 0, 0)'}),
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'board.choice': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 5, 0, 0)'}),
        ...
        u'board.phone': {
            ...
            'date_of_addition': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
