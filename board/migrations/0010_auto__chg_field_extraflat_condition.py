...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'board_extraflat', 'condition', self.gf('django.db.models.fields.CharField')(default='', max_length=70))

    def backwards(self, orm):

        # Changing field 'ExtraFlat.condition'
        db.alter_column(u'board_extraflat', 'condition', self.gf('django.db.models.fields.CharField')(max_length=70, null=True))
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 25, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
