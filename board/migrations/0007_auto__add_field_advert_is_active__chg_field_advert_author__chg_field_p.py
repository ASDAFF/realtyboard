...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advert.is_active'
        db.add_column(u'board_advert', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Advert.author'
        db.alter_column(u'board_advert', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.UserData'], null=True))

        # Changing field 'Phone.owner'
        db.alter_column(u'board_phone', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.UserData'], null=True))

    def backwards(self, orm):
        # Deleting field 'Advert.is_active'
        db.delete_column(u'board_advert', 'is_active')
