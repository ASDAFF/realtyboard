...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MetroLine'
        db.create_table(u'board_metroline', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.City'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=40)),
        ))
        db.send_create_signal(u'board', ['MetroLine'])

        # Adding field 'Metro.line'
        db.add_column(u'board_metro', 'line',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.MetroLine'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MetroLine'
        db.delete_table(u'board_metroline')

        # Deleting field 'Metro.line'
        db.delete_column(u'board_metro', 'line_id')
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 17, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
