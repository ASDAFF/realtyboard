...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Choice.pub_date'
        db.add_column(u'board_choice', 'pub_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 4, 24, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Choice.pub_date'
        db.delete_column(u'board_choice', 'pub_date')
