...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'board_choice', 'votes')


    def backwards(self, orm):
        # Adding field 'Choice.votes'
        db.add_column(u'board_choice', 'votes',
                      self.gf('django.db.models.fields.BooleanField')(default=datetime.datetime(2014, 4, 24, 0, 0)),
                      keep_default=False)
