...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CuttingWords'
        db.create_table(u'board_cuttingwords', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cut_words', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('all', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'board', ['CuttingWords'])


        # Changing field 'Phone.date_of_addition'
        db.alter_column(u'board_phone', 'date_of_addition', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):
        # Deleting model 'CuttingWords'
        db.delete_table(u'board_cuttingwords')


        # Changing field 'Phone.date_of_addition'
        db.alter_column(u'board_phone', 'date_of_addition', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 25, 0, 0)'}),
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 25, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 25, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'board.choice': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 25, 0, 0)'}),
        ...
        u'board.phone': {
            ...
            'date_of_addition': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 25, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
