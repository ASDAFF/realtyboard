...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'board_sublocality', 'subloc_province',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['board.Big_sublocality']),
                      keep_default=False)
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'board.big_sublocality': {
            'Meta': {'object_name': 'Big_sublocality'},
        ...
        u'board.sublocality': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'subloc_province': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['board.Big_sublocality']"})
        },
