...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExtraHouse.lot_unit'
        db.alter_column(u'board_extrahouse', 'lot_unit', self.gf('django.db.models.fields.CharField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'ExtraHouse.lot_unit'
        db.alter_column(u'board_extrahouse', 'lot_unit', self.gf('django.db.models.fields.CharField')(max_length=8))
    ...
    models = {
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 26, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'board.extrahouse': {
            ...
            'lot_unit': ('django.db.models.fields.CharField', [], {'default': "(u'\\u0441\\u043e\\u0442\\u043e\\u043a', u'\\u0441\\u043e\\u0442\\u043e\\u043a')", 'max_length': '15', 'blank': 'True'}),
            'total_area': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
