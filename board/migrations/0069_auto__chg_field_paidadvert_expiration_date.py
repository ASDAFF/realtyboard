...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PaidAdvert.expiration_date'
        db.alter_column(u'board_paidadvert', 'expiration_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'PaidAdvert.expiration_date'
        db.alter_column(u'board_paidadvert', 'expiration_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'board.adverttodelete': {
            ...
            'date_of_del': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
