...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Advert.is_active'
        db.alter_column(u'board_advert', 'is_active', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Advert.is_active'
        db.alter_column(u'board_advert', 'is_active', self.gf('django.db.models.fields.BooleanField')())
