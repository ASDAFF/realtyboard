...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Category.city'
        raise RuntimeError("Cannot reverse this migration. 'Category.city' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Category.city'
        db.add_column(u'board_category', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.City']),
                      keep_default=False)
