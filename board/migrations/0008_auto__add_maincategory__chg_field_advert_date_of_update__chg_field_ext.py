...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'board_maincategory', (
        ...
        db.send_create_signal(u'board', ['MainCategory'])


        # Changing field 'Advert.date_of_update'
        db.alter_column(u'board_advert', 'date_of_update', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ExtraSale.price_unit'
        db.alter_column(u'board_extrasale', 'price_unit', self.gf('django.db.models.fields.SmallIntegerField')())

    def backwards(self, orm):
        # Deleting model 'MainCategory'
        db.delete_table(u'board_maincategory')


        # Changing field 'Advert.date_of_update'
        db.alter_column(u'board_advert', 'date_of_update', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ExtraSale.price_unit'
        db.alter_column(u'board_extrasale', 'price_unit', self.gf('django.db.models.fields.SmallIntegerField')(max_length=10))
