...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserOperation.advert'
        db.add_column(u'personal_useroperation', 'advert',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.Advert'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserOperation.advert'
        db.delete_column(u'personal_useroperation', 'advert_id')
