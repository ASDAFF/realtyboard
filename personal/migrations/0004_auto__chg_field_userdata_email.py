...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserData.email'
        db.alter_column(u'personal_userdata', 'email', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=75))

    def backwards(self, orm):

        # Changing field 'UserData.email'
        db.alter_column(u'personal_userdata', 'email', self.gf('django.db.models.fields.CharField')(max_length=75, unique=True))
