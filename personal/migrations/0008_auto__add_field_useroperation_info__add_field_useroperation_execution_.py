...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserOperation.info'
        db.add_column(u'personal_useroperation', 'info',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'UserOperation.execution_date'
        db.add_column(u'personal_useroperation', 'execution_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 12, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'UserOperation.term'
        db.add_column(u'personal_useroperation', 'term',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'UserOperation.expiration_date'
        db.add_column(u'personal_useroperation', 'expiration_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'UserOperation.operation'
        db.alter_column(u'personal_useroperation', 'operation', self.gf('django.db.models.fields.SmallIntegerField')())

    def backwards(self, orm):
        # Deleting field 'UserOperation.info'
        db.delete_column(u'personal_useroperation', 'info')

        # Deleting field 'UserOperation.execution_date'
        db.delete_column(u'personal_useroperation', 'execution_date')

        # Deleting field 'UserOperation.term'
        db.delete_column(u'personal_useroperation', 'term')

        # Deleting field 'UserOperation.expiration_date'
        db.delete_column(u'personal_useroperation', 'expiration_date')


        # Changing field 'UserOperation.operation'
        db.alter_column(u'personal_useroperation', 'operation', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        u'personal.useroperation': {
            ...
            'term': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
