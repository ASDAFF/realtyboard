...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserWalletHistory'
        db.create_table(u'personal_userwallethistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.UserData'])),
            ('deposit', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['personal.UserPayment'], unique=True, null=True, blank=True)),
            ('withdraw', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['personal.UserOperation'], unique=True, null=True, blank=True)),
            ('new_sum', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('info', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'personal', ['UserWalletHistory'])

        # Adding field 'UserPayment.service'
        db.add_column(u'personal_userpayment', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.PayedService'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'UserPayment.date'
        db.alter_column(u'personal_userpayment', 'date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'UserPayment.amount'
        db.alter_column(u'personal_userpayment', 'amount', self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2))
        # Adding field 'UserOperation.service'
        db.add_column(u'personal_useroperation', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['personal.PayedService']),
                      keep_default=False)

        # Adding field 'UserOperation.payment'
        db.add_column(u'personal_useroperation', 'payment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.UserPayment'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'UserOperation.operation'
        db.alter_column(u'personal_useroperation', 'operation', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

    def backwards(self, orm):
        # Deleting model 'UserWalletHistory'
        db.delete_table(u'personal_userwallethistory')

        # Deleting field 'UserPayment.service'
        db.delete_column(u'personal_userpayment', 'service_id')


        # Changing field 'UserPayment.date'
        db.alter_column(u'personal_userpayment', 'date', self.gf('django.db.models.fields.DateField')())
        ...
        # Deleting field 'UserOperation.service'
        db.delete_column(u'personal_useroperation', 'service_id')

        # Deleting field 'UserOperation.payment'
        db.delete_column(u'personal_useroperation', 'payment_id')


        # Changing field 'UserOperation.operation'
        db.alter_column(u'personal_useroperation', 'operation', self.gf('django.db.models.fields.SmallIntegerField')(default=1))
    ...
    models = {
        ...
        u'personal.payedservice': {
            'Meta': {'object_name': 'PayedService'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
        ...
        u'personal.userdata': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['personal.PayedService']", 'null': 'True', 'blank': 'True'}),
        ...
        u'personal.useroperation': {
            ...
            'operation': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'payment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['personal.UserPayment']", 'null': 'True', 'blank': 'True'}),
            'service': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['personal.PayedService']"}),
        ...
        u'personal.userpayment': {
            ...
            'service': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['personal.PayedService']", 'null': 'True', 'blank': 'True'}),
        ...
        u'personal.userwallethistory': {
            'Meta': {'object_name': 'UserWalletHistory'},
            'deposit': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['personal.UserPayment']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'info': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'new_sum': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['personal.UserData']"}),
            'withdraw': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['personal.UserOperation']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        }
    }
