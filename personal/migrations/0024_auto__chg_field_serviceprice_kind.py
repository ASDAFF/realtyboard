...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServicePrice.kind'
        db.alter_column(u'personal_serviceprice', 'kind', self.gf('django.db.models.fields.CharField')(max_length=25))

    def backwards(self, orm):

        # Changing field 'ServicePrice.kind'
        db.alter_column(u'personal_serviceprice', 'kind', self.gf('django.db.models.fields.CharField')(max_length=10))
