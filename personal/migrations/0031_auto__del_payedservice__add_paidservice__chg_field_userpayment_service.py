...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'PayedService'
        db.delete_table(u'personal_payedservice')

        # Removing M2M table for field prices on 'PayedService'
        db.delete_table(db.shorten_name(u'personal_payedservice_prices'))

        # Adding model 'PaidService'
        db.create_table(u'personal_paidservice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('ru_name', self.gf('django.db.models.fields.CharField')(max_length=40)),
        ))
        db.send_create_signal(u'personal', ['PaidService'])

        # Adding M2M table for field prices on 'PaidService'
        m2m_table_name = db.shorten_name(u'personal_paidservice_prices')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('paidservice', models.ForeignKey(orm[u'personal.paidservice'], null=False)),
            ('serviceprice', models.ForeignKey(orm[u'personal.serviceprice'], null=False))
        ))
        db.create_unique(m2m_table_name, ['paidservice_id', 'serviceprice_id'])


        # Changing field 'UserPayment.service'
        db.alter_column(u'personal_userpayment', 'service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.PaidService'], null=True))

        # Changing field 'UserOperation.service'
        db.alter_column(u'personal_useroperation', 'service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.PaidService']))

    def backwards(self, orm):
        # Adding model 'PayedService'
        db.create_table(u'personal_payedservice', (
            ('ru_name', self.gf('django.db.models.fields.CharField')(max_length=40)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'personal', ['PayedService'])

        # Adding M2M table for field prices on 'PayedService'
        m2m_table_name = db.shorten_name(u'personal_payedservice_prices')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('payedservice', models.ForeignKey(orm[u'personal.payedservice'], null=False)),
            ('serviceprice', models.ForeignKey(orm[u'personal.serviceprice'], null=False))
        ))
        db.create_unique(m2m_table_name, ['payedservice_id', 'serviceprice_id'])

        # Deleting model 'PaidService'
        db.delete_table(u'personal_paidservice')

        # Removing M2M table for field prices on 'PaidService'
        db.delete_table(db.shorten_name(u'personal_paidservice_prices'))


        # Changing field 'UserPayment.service'
        db.alter_column(u'personal_userpayment', 'service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.PayedService'], null=True))

        # Changing field 'UserOperation.service'
        db.alter_column(u'personal_useroperation', 'service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.PayedService']))
    ...
    models = {
        ...
        u'personal.userpayment': {
            ...
            'service': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['personal.PaidService']", 'null': 'True', 'blank': 'True'}),
