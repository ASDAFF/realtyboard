...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserDataSocial'
        db.create_table(u'personal_userdatasocial', (
        ...
        db.send_create_signal(u'personal', ['UserDataSocial'])
    ...
    def backwards(self, orm):
        # Deleting model 'UserDataSocial'
        db.delete_table(u'personal_userdatasocial')


        # Changing field 'UserPayment.date'
        db.alter_column(u'personal_userpayment', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
