...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserData.services'
        db.delete_column(u'personal_userdata', 'services_id')

        # Adding M2M table for field services on 'UserData'
        m2m_table_name = db.shorten_name(u'personal_userdata_services')
        ...
        db.create_unique(m2m_table_name, ['userdata_id', 'payedservice_id'])


    def backwards(self, orm):
        # Adding field 'UserData.services'
        db.add_column(u'personal_userdata', 'services',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.PayedService'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field services on 'UserData'
        db.delete_table(db.shorten_name(u'personal_userdata_services'))
