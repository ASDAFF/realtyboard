...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserData.remember'
        db.add_column(u'personal_userdata', 'remember',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'UserPayment.duration'
        db.add_column(u'personal_userpayment', 'duration',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserData.remember'
        db.delete_column(u'personal_userdata', 'remember')

        # Deleting field 'UserPayment.duration'
        db.delete_column(u'personal_userpayment', 'duration')
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 10, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'personal.useroperation': {
            'Meta': {'ordering': "['-pk']", 'object_name': 'UserOperation'},
