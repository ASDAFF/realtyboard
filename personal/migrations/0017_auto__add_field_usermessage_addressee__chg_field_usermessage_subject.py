...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserMessage.addressee'
        db.add_column(u'personal_usermessage', 'addressee',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=4000, blank=True),
                      keep_default=False)


        # Changing field 'UserMessage.subject'
        db.alter_column(u'personal_usermessage', 'subject', self.gf('django.db.models.fields.TextField')(max_length=4000))

    def backwards(self, orm):
        # Deleting field 'UserMessage.addressee'
        db.delete_column(u'personal_usermessage', 'addressee')


        # Changing field 'UserMessage.subject'
        db.alter_column(u'personal_usermessage', 'subject', self.gf('ckeditor.fields.RichTextField')(max_length=4000))
