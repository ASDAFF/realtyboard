...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PayedService.prices'
        db.delete_column(u'personal_payedservice', 'prices_id')
    ...
    def backwards(self, orm):
        # Adding field 'PayedService.prices'
        db.add_column(u'personal_payedservice', 'prices',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['personal.ServicePrice']),
                      keep_default=False)
    ...
    models = {
        ...
        u'personal.userdata': {
            ...
            'services': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['personal.PayedService']", 'null': 'True', 'blank': 'True'}),
