...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'personal_payedservice', (
            ...
            ('prices', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.ServicePrice'])),
        ))
    ...
    models = {
        ...
        u'personal.payedservice': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'prices': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['personal.ServicePrice']"})
        },
