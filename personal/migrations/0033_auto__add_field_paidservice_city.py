...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaidService.city'
        db.add_column(u'personal_paidservice', 'city',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['board.City'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaidService.city'
        db.delete_column(u'personal_paidservice', 'city_id')
