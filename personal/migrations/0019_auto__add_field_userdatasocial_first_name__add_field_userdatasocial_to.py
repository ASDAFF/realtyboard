...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserDataSocial.first_name'
        db.add_column(u'personal_userdatasocial', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='old', max_length=30),
                      keep_default=False)

        # Adding field 'UserDataSocial.token'
        db.add_column(u'personal_userdatasocial', 'token',
                      self.gf('django.db.models.fields.CharField')(default='empty', max_length=100),
                      keep_default=False)


        # Changing field 'UserDataSocial.user'
        db.alter_column(u'personal_userdatasocial', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.UserData'], null=True))

    def backwards(self, orm):
        # Deleting field 'UserDataSocial.first_name'
        db.delete_column(u'personal_userdatasocial', 'first_name')

        # Deleting field 'UserDataSocial.token'
        db.delete_column(u'personal_userdatasocial', 'token')


        # Changing field 'UserDataSocial.user'
        db.alter_column(u'personal_userdatasocial', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['personal.UserData']))
