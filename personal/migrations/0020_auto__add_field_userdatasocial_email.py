...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserDataSocial.email'
        db.add_column(u'personal_userdatasocial', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='empty', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserDataSocial.email'
        db.delete_column(u'personal_userdatasocial', 'email')
