...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'personal_usermessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('subject', self.gf('ckeditor.fields.RichTextField')(max_length=4000)),
            ('mail_text', self.gf('ckeditor.fields.RichTextField')(max_length=4000)),
            ('sender', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'personal', ['UserMessage'])


        # Changing field 'UserOperation.execution_date'
        db.alter_column(u'personal_useroperation', 'execution_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting model 'UserMessage'
        db.delete_table(u'personal_usermessage')


        # Changing field 'UserOperation.execution_date'
        db.alter_column(u'personal_useroperation', 'execution_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 31, 0, 0)'}),
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 31, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'personal.usermessage': {
            ...
            'subject': ('ckeditor.fields.RichTextField', [], {'max_length': '4000'})
        },
        u'personal.useroperation': {
            ...
            'execution_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 31, 0, 0)'}),
