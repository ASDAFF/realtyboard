...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ServicePrice'
        db.create_table(u'personal_serviceprice', (
            ...
            ('for_btn', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ))
        db.send_create_signal(u'personal', ['ServicePrice'])


        # Changing field 'UserData.creation_date'
        db.alter_column(u'personal_userdata', 'creation_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):
        # Deleting model 'ServicePrice'
        db.delete_table(u'personal_serviceprice')


        # Changing field 'UserData.creation_date'
        db.alter_column(u'personal_userdata', 'creation_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        u'personal.serviceprice': {
            ...
            'for_btn': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
