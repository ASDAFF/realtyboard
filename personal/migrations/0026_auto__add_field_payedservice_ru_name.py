...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PayedService.ru_name'
        db.add_column(u'personal_payedservice', 'ru_name',
                      self.gf('django.db.models.fields.CharField')(default='emty', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PayedService.ru_name'
        db.delete_column(u'personal_payedservice', 'ru_name')
