...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserPayment.order_id'
        db.alter_column(u'personal_userpayment', 'order_id', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'UserPayment.order_id'
        db.alter_column(u'personal_userpayment', 'order_id', self.gf('django.db.models.fields.IntegerField')())
