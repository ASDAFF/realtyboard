...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserOperation.operation_type'
        db.delete_column(u'personal_useroperation', 'operation_type')

        # Adding field 'UserOperation.action'
        db.add_column(u'personal_useroperation', 'action',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserOperation.operation_type'
        db.add_column(u'personal_useroperation', 'operation_type',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'UserOperation.action'
        db.delete_column(u'personal_useroperation', 'action')
