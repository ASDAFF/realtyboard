...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserData.memoirs'
        db.add_column(u'personal_userdata', 'memoirs',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=100000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserData.memoirs'
        db.delete_column(u'personal_userdata', 'memoirs')
    ...
    models = {
        ...
        u'board.advert': {
            ...
            'date_of_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 11, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
