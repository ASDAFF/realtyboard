...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageText.name'
        db.add_column(u'lesnoe_pagetext', 'name',
                      self.gf('django.db.models.fields.CharField')(default=u'\u0442\u0435\u043a\u0441\u0442 \u0441\u0442\u0440\u0430\u043d\u0438\u0446\u044b', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageText.name'
        db.delete_column(u'lesnoe_pagetext', 'name')
    ...
    models = {
        ...
        u'lesnoe.pagetext': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "u'\\u0442\\u0435\\u043a\\u0441\\u0442 \\u0441\\u0442\\u0440\\u0430\\u043d\\u0438\\u0446\\u044b'", 'max_length': '20'}),
