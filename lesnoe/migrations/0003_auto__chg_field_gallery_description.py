...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'lesnoe_gallery', 'description', self.gf('django.db.models.fields.CharField')(max_length=350))

    def backwards(self, orm):

        # Changing field 'Gallery.description'
        db.alter_column(u'lesnoe_gallery', 'description', self.gf('django.db.models.fields.CharField')(max_length=200))
