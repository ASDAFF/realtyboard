...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlackListComment'
        db.create_table(u'news_blacklistcomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['news.BlackList'])),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.UserData'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'news', ['BlackListComment'])


    def backwards(self, orm):
        # Deleting model 'BlackListComment'
        db.delete_table(u'news_blacklistcomment')
    ...
    models = {
        ...
        u'news.blacklistcomment': {
            'Meta': {'object_name': 'BlackListComment'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['personal.UserData']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['news.BlackList']"}),
