...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlackList.author'
        db.add_column(u'news_blacklist', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=98, to=orm['personal.UserData']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlackList.author'
        db.delete_column(u'news_blacklist', 'author_id')
